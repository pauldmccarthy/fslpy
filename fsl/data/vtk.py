...
def getFIRSTPrefix(modelfile):
    """If the given ``vtk`` file was generated by :fsldocs:`FIRST
    <structural/first.html>`, this function will return the file
    prefix. Otherwise a ``ValueError`` will be raised.
    """
...
def findReferenceImage(modelfile):
    ...
    generated by :fsldocs:`FIRST <structural/first.html>`.
    """
